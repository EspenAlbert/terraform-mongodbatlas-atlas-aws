# Contributing to terraform-mongodbatlas-atlas-aws
...
# Clone and setup
git clone <repo-url>
cd terraform-mongodbatlas-atlas-aws
...
See [test-guide.md](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-aws/blob/v0.0.1/contributing/test-guide.md) for detailed testing documentation including:
